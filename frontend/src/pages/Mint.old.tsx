			...
			>
				<div className="max-w-2xl mx-auto text-center p-8 animate-scale-in">
					...
					<p
						...
						`}
					>
						Your NFT has been minted with multi-URI protection
					</p>
						...
						>
							...
							<a
								...
								className={`
									...
									${
										isDarkMode
											? "bg-primary-dark hover:bg-primary-dark-hover text-bg-dark"
							...
							<p
								...
								`}
							>
								Network: {network.charAt(0).toUpperCase() + network.slice(1)} • Token #{mintedTokenId}
							</p>
						</div>
					)}
	...
	return (
		...
		>
			...
			<div className="flex-grow">
				<form
					onSubmit={onSubmit}
					className="px-4 md:px-6 lg:px-8 py-8 max-w-4xl mx-auto space-y-8"
				>
					<div className="text-center md:text-left">
						...
						<p
							...
							`}
						>
							Mint your {type === "ERC1155" ? "multiple edition" : "single edition"} NFT
							with multi-URI protection
						</p>
					</div>
					...
					>
						...
						<p
							...
							`}
						>
							We'll calculate a unique hash to verify your file's authenticity
						</p>
						<div
					...
					>
						...
						<p
							...
							`}
						>
							Add a title, description, and any properties that describe your work
						</p>
						<div className="space-y-4">
							<div>
					...
					>
						...
						<p
							...
							`}
						>
							Upload your artwork to multiple platforms for maximum resilience. More backups = better protection.
						</p>
						<div>
					...
					>
						...
						<p
							...
							`}
						>
							How should your NFT handle backup links?
						</p>
						<div className="space-y-4">
							<div>
					...
					>
						...
						<p
							...
							`}
						>
							Choose where to store your NFT's preview image
						</p>
					...
					>
						...
						<p
							...
							`}
						>
							What actions can you keep as the artist? (You can revoke these later to increase trust)
						</p>
						<div className="space-y-3">
					...
					>
						...
						<p
							...
							`}
						>
							What can collectors do with your artwork? (Permanent - choose carefully!)
						</p>
						<div className="space-y-3">
							<label className="flex items-center gap-3">
								<input
					...
					>
						<h3
							...
							`}
						>
							8. {type === "ERC1155" ? "Recipients & Quantities" : "Who receives this NFT?"}
						</h3>
						<p
							className={`
								text-sm mb-6
						...
						>
							{type === "ERC1155" 
								? "Specify who receives copies and how many" 
					...
					<div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-4">
						...
						<button
							...
							className={`
								...
								transition-all duration-200
								${
									!name || !artistArtworkUris.trim() || recipientsArr.length === 0 || isPending || isConfirming || !!simulateError
										...
										: "bg-primary hover:bg-primary-hover dark:bg-primary-dark dark:hover:bg-primary-dark-hover text-white shadow-medium hover:shadow-strong"
								}
							`}
							disabled={
								!name ||
					...
					{hash && !isSuccess && (
						<div
							className={`
								...
								${
									isDarkMode
										? "bg-info-dark-subtle border border-info-dark/30"
						...
						>
							<p
								className={`
									text-sm font-medium
									${isDarkMode ? "text-info-dark" : "text-info"}
								`}
							>
					...
					{writeError && (
						<div
							className={`
								...
								${
									isDarkMode
										? "bg-danger-dark-subtle border border-danger-dark/30"
										: "bg-danger-subtle border border-danger/30"
								}
							`}
						>
							<div className="text-center">
								<h3
									className={`
										text-lg font-bold mb-2
										${isDarkMode ? "text-danger-dark" : "text-danger"}
									`}
								>
									Transaction Failed
								</h3>
								...
								{writeError?.message && writeError.message.length > 100 && (
									...
									>
										...
										<div className="mt-2 p-3 rounded bg-black/10 max-h-40 overflow-auto">
